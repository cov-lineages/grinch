...
def check_dependencies():
    ...
    dependency_list = ["gofasta","minimap2","snakemake","usher","pangolin"]
    module_list = ["Bio","sklearn","pandas","joblib","pysam",
    "pangoLEARN","reportfunk","datafunk",
    "fastafunk",
    "constellations"]
