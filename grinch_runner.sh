...
grinch -t 5 -i /raid/shared/grinch/grinch/data/config.yaml --outdir "/raid/shared/$TODAY" --output-prefix global_report

cd /home/shared/lineages-website && git pull

python /raid/shared/grinch/grinch/scripts/update_website.py --website-dir /home/shared/lineages-website -m /raid/shared/$TODAY/2/lineages.metadata.csv -n /home/shared/pangoLEARN/pangoLEARN/supporting_information/lineage_notes.txt -o /home/shared/lineages-website/_data/lineage_data.json
